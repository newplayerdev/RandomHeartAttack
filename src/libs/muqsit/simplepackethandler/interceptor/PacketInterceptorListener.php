...
namespace NewPlayerMC\RandomHeartAttack\libs\muqsit\simplepackethandler\interceptor;

use Closure;
use NewPlayerMC\RandomHeartAttack\libs\muqsit\simplepackethandler\utils\Utils;
